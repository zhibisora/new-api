...
func SendEmailVerification(c *gin.Context) {
	...
	if err := common.RegisterVerificationCodeWithKey(email, code, common.EmailVerificationPurpose); err != nil {
		logger.LogError(c.Request.Context(), "failed to store email verification code: "+err.Error())
...
func ResetPassword(c *gin.Context) {
	...
	if err != nil {
		logger.LogError(c.Request.Context(), "failed to load password reset code: "+err.Error())
		common.ApiErrorI18n(c, i18n.MsgRetryLater)
		return
	}
	if !valid {
	...
	if err := common.DeleteKey(req.Email, common.PasswordResetPurpose); err != nil {
		logger.LogError(c.Request.Context(), "failed to delete password reset code: "+err.Error())
	}
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "",
